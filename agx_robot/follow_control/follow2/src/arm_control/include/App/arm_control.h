...
public:
    ...
    void init_step(ecat::EcatBase ecat_base);
    ...
    void set_zero(void);
    void update(void);
    void update_real(ecat::EcatBase ecat_base);
    void motor_control(ecat::EcatBase ecat_base);
    void joint_control(ecat::EcatBase ecat_base);
    void gripper_control(ecat::EcatBase ecat_base);
